...
const Message = () => {
  return (
    ...
    <p className="max-w-4xl text-xl font-medium text-center md:text-2xl lg:text-3xl">"As the Principal of Makalu Engineering Boarding School, I am delighted with our institution's dedication to fostering a nurturing and intellectually stimulating environment for students. Our esteemed faculty, modern facilities, and comprehensive curriculum provide a well-rounded education for academic excellence and personal growth."
        </p>
