    ...
    <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            <div className="max-w-lg">
                <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">About <span className='bg-blue-600 text-white pl-1 pr-1 rounded-sm'>Makalu School</span></h2>
            ...
            <div className="mt-12 md:mt-0">
                <img src="http://localhost:1337/uploads/Whats_App_Image_2024_06_11_at_21_31_29_0ea7ae98_36680435db.jpg" alt="About Us Image" className="object-cover rounded-lg shadow-md"/>
            </div>
        </div>
    </div>
</section></div>
