    ...
    <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <div className="space-y-2 text-sm">
        ...
        <div className="flex">
          ...
          <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800"> (+977)9852048899

</a>
        </div>
        <div className="flex">
          <p className="mr-1 text-gray-800">Email:</p>
          <a href="mebs2057@gmail.com" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">mebs2057@gmail.com
      ...
      <div>
        ...
        <div className="flex items-center mt-1 space-x-3">
          ...
          <a href="/" className="text-gray-500 transition-colors duration-300 hover:text-blue-600">
            <svg viewBox="0 0 24 24" fill="currentColor" className="h-5">
              <path
